<?php
     ...
     chdir("../");
     $dir = substr($cwd, 0, (strlen($cwd) - 3));

     $folder = "html/";       // Set the folder variable to specify the "current" directory    
     ...
     *****************************************************************/
     ...
     for ($i = 0; $i < sizeof($files); $i++) {
        ...
        $directory[$i]->fileType = fileType($dir.$folder.$directory[$i]->fileName);
        $directory[$i]->cwd = $dir.$folder;
     }
